...
public class thirdHighScoreButton extends Fragment {
    private List<ProgressBar> progressBars;
    private TextView t1;
    private TextView t2;
    private TextView t3;
    public thirdHighScoreButton() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_third_high_score_button, container, false);
        progressBars.add((ProgressBar) v.findViewById(R.id.progress_V_1));
        progressBars.add((ProgressBar) v.findViewById(R.id.progress_V_2));
        progressBars.add((ProgressBar) v.findViewById(R.id.progress_V_3));

...
# input_fn = tf.estimator.inputs.numpy_input_fn({"x": x_train}, y_train,
...
# # The connection to the C++ backend is called a session
...
#
# # Initialize variables within the session
...
# Add another layer to make it a deep neural network
...
# We apply a dropout layer to reduce overfitting
